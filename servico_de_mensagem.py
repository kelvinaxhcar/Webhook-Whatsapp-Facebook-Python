...
def obter_dados_da_mensagem(request):
    ...
    valor = json_convertido[constantes_do_servico_de_mensagem.entry][constantes_do_servico_de_mensagem.zero][constantes_do_servico_de_mensagem.changes][constantes_do_servico_de_mensagem.zero][constantes_do_servico_de_mensagem.value]
